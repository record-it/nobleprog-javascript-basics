window.onload = function(){
    ...
    const liPeopleElements = document.querySelectorAll("#people li");         //elementy li listy ul o podanym id
    console.log("li from people list")
    console.log(liPeopleElements);  
